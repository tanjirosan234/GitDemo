...
import dataProvider.ConfigFileReaderThreeCommas;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestsThreeCommas {

	WebDriver driver;
	String browserId;
	ConfigFileReaderThreeCommas configFileReader= new ConfigFileReaderThreeCommas();
