...
import dataProvider.ConfigFileReaderFamilyPlay;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestsFamilyPlay {

	WebDriver driver;
	String browserId;
	ConfigFileReaderFamilyPlay configFileReader= new ConfigFileReaderFamilyPlay();
...
**************************************/	
	...
	**************************************************************************/
	...
	/**************************************************************************
	//Test for back from Registration
	**************************************************************************/
	...
	**************************************************************************/
	...
	/**************************************************************************
	//Test for checking subscribe elements
	**************************************************************************/
	...
	**************************************************************************/
	...
	public void SubscribeEmptyFieldsTest() throws InterruptedException {
		...
		Assert.assertTrue(driver.findElement(By.id("auto-required_country")).getText().contains(configFileReader.getFieldRequiredText()));
	...
	**************************************************************************/
	...
	public void SubscribeShortPasswordTest() throws InterruptedException {
		...
		WebElement elem = driver.findElement(By.id("auto-subscription-password"));
	...
	**************************************************************************/
	...
	public void SubscribeNotMatchedPasswordTest() throws InterruptedException {
		...
		WebElement elem = driver.findElement(By.id("auto-subscription-password"));
		elem.findElement(By.tagName("input")).clear();
		elem.findElement(By.tagName("input")).sendKeys(configFileReader.getCorrectPassText());
