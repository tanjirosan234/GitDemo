...
**************************************/	
	...
	***************************************************************************/
	...
	public void EmptyLoginTest() {
		...
		Assert.assertEquals(driver.findElement(By.id("autotest-password-filedisreq")).getText(), configFileReader.getFieldRequiredText());
	}
	...
	public void WrongLoginTest() throws InterruptedException {
		...
		Assert.assertEquals(driver.findElement(By.id("autotest-login-usernotfound")).getText(), configFileReader.getIncorrectUserPassMsgText());
	}
	...
	**************************************************************************/
	...
	public void SubscribeButtonTest() throws InterruptedException {
		...
		driver.manage().timeouts().implicitlyWait(configFileReader.getImplicitlyWait(), TimeUnit.SECONDS);
		Thread.sleep(3000);	
		//Click on subscribe button in header
		driver.findElement(By.id("auto-test-subscribeButtonTop")).click();
	
	}
	
	/**************************************************************************
	//Test for button Cancel - cancel button Rejected
	**************************************************************************/
	...
	public void SubscribeCancelTest() throws InterruptedException {
		...
		//Click on subscribe button in header again
		Thread.sleep(1500);
		driver.findElement(By.id("auto-test-subscribeButtonTop")).click();
	}
