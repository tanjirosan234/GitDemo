...
import dataProvider.ConfigFileReaderLen;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestsLen {

	WebDriver driver;
	String browserId;
	ConfigFileReaderLen configFileReader= new ConfigFileReaderLen();
...
**************************************/	
	...
	**************************************************************************/
	...
	public void MyAccountTest() throws InterruptedException {
		...
		driver.get(configFileReader.getApplicationUrl() + "/user");
		//driver.findElement(By.id("auto-login-avatar-face")).click();
