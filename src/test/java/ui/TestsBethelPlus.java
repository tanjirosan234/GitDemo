...
import dataProvider.ConfigFileReaderBethelPlus;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestsBethelPlus {

	WebDriver driver;
	String browserId;
	ConfigFileReaderBethelPlus configFileReader= new ConfigFileReaderBethelPlus();
...
**************************************/	
	...
	**************************************************************************/
	...
	public void LogoutTest() throws InterruptedException {
		...
		Assert.assertTrue(loginMenu.findElement(By.tagName("a")).getText().contains(configFileReader.getLoginTitleText()));
	}	
