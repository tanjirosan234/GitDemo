...
import dataProvider.ConfigFileReaderSwarmio;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestsSwarmio {

	WebDriver driver;
	String browserId;
	ConfigFileReaderSwarmio configFileReader= new ConfigFileReaderSwarmio();
...
**************************************/	
	...
	**************************************************************************/
	...
	public void CheckSubscribeFieldsTest() throws InterruptedException {
		...
		//Check Female check box
		driver.findElement(By.id("autotest-female-Teletica"));
		//Check Other check box
		driver.findElement(By.id("autotest-other-Teletica"));
	...
	**************************************************************************/
	...
	public void SubscribeSelectMaleCheckBoxTest() throws InterruptedException {
