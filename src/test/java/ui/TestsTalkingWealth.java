...
import dataProvider.ConfigFileReaderTalkingWealth;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestsTalkingWealth {

	WebDriver driver;
	String browserId;
	ConfigFileReaderTalkingWealth configFileReader= new ConfigFileReaderTalkingWealth();
