...
import dataProvider.ConfigFileReaderCariflix;
import io.github.bonigarcia.wdm.WebDriverManager;

public class TestsCariflix {

	WebDriver driver;
	String browserId;
	ConfigFileReaderCariflix configFileReader= new ConfigFileReaderCariflix();
...
**************************************/	
	...
	**************************************************************************/
	...
	/**************************************************************************
	//Test for choosing plan
	**************************************************************************/
	@Test(priority=23, enabled=true)
	public void ChoosePlanTest() throws InterruptedException {
	...
	/**************************************************************************
	//Test for choosing pay card and continue
	**************************************************************************/
	@Test(priority=24, enabled=true)
	public void ChoosePayCardTest() throws InterruptedException {
		
		driver.manage().timeouts().implicitlyWait(configFileReader.getImplicitlyWait(), TimeUnit.SECONDS);
			
		//Click on pay-card screen continue
